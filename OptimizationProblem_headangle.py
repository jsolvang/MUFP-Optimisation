...
def OptimizationProblem(x_space, y_space, dia_column, draft):
    ...
    tz_wave, sa_wave, n_mpm_wave, mpm_wave, rao_wave, _, _, _, _ = wavespectrumanalysis(sim, matrix, plot, mufp, coord,
                                                                                        df_rad,
                                                                                        f_rad, Tr)
    ...
    return sa, mpm, rao_wave, rao_wind, matrix.stiffness, nat_freq_damped, mass.steel_mass
