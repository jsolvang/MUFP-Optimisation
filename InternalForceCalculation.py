...
def calc_column_stiffness(rho, area, env, buoy, mufp, coord, COM):
    ...
    # Value taken from HydroD model of single column, still unsure the reason for the difference.
    # This can also be found in the folder
    # Keeping inputs consistent with HydroD for now
    #stiffness_matrix[3, 3] = 3.835E+07
    #stiffness_matrix[4, 4] = 3.835E+07
